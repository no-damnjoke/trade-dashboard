...
export async function evaluateOpportunities(snapshot: OpportunitySnapshot) {
  ...
  const systemPrompt = [
    ...
    '   - Reference concrete PRICE LEVELS from candle data, not just percentage changes.',
    ...
    '   - "keyLevels": { "support": [...], "resistance": [...] } — use ACTUAL PRICE LEVELS from the candle/quote data. Not percentage thresholds like "+0.30%". If you only have percentage data, derive approximate levels from currentPrice.',
