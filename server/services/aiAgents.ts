...
export async function evaluateOpportunities(snapshot: OpportunitySnapshot) {
  ...
  const systemPrompt = [
    ...
    '   - When haven currencies are not behaving as expected, explain the transmission channel (energy/inflation path vs classic risk-off), not just "market is ignoring risk."',
